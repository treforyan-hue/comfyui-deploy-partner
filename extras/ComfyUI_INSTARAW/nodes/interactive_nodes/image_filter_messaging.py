...
class Response:
    def __init__(self, selection:Optional[List[str]] = None, text:Optional[str] = None,
        ...
        self.masked_data:Optional[str]  = masked_data  # Base64 data URL from new mask editor
...
def wait_for_response(secs, uid, unique) -> Response:
    ...
    try:
        ...
        # Give a 2 second grace period before checking for interrupts
        # This allows the mask editor to fully initialize
